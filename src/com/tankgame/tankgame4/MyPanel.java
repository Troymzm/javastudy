...
public class MyPanel extends JPanel implements KeyListener, Runnable {
    ...
    public MyPanel(String key) {
        ...
        if (!file.exists()) {
            System.out.println("文件不存在，默认开始新游戏");
            key = "1";
        }
        // 将enemyTanks设置给Recorder对象
...
//        hero.setSpeed(20);
        switch (key) {
            ...
            case "2": // 继续上局游戏
                ...
                for (int i = 0; i < nodes.size(); i++) {  // 初始化敌人的坦克
        ...
        // 初始化图片对象
        image1 = Toolkit.getDefaultToolkit().getImage("src/com/1.png");
        image2 = Toolkit.getDefaultToolkit().getImage("src/com/2.png");
        image3 = Toolkit.getDefaultToolkit().getImage("src/com/3.png");
    }
